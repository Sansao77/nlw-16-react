    ...
    <div className="h-screen flex items-center justify-center bg-pattern bg-no-repeat bg-center">
      <div className="max-w-3xl w-full  px-6 text-center space-y-10">
        ...
        <div className='space-y-4'>
            ...
            {isGuestsInputOpen ? (
              <button onClick={closeGuestsInput} type='button' className='bg-zinc-800 text-zinc-200 rounded-lg 
              px-5 py-2 font-medium flex items-center gap-2 hover:bg-zinc-700'>
                Alterar local/data
                <Settings2 className='size-5'/>
              </button>
            ):(
              <button onClick={openGuestsInput} type="button" className='bg-lime-300 text-lime-950 rounded-lg 
          ...
          {isGuestsInputOpen && (
            ...
            <button type='button' onClick={openGuestsModal} className="flex items-center gap-2 flex-1">
              ...
              <span className='text-zinc-400 text-left text-lg flex-1'>Quem estara na viagem?</span>
            </button>

            <div className='w-px h-6 bg-zinc-800'/>

            <button type="button" className='bg-lime-300 text-lime-950 rounded-lg 
            px-5 py-2 font-medium flex items-center gap-2 hover:bg-lime-400'>
              Confirmar viagem
              <ArrowRight className='size-5'/>
            </button>
          ...
          <div className='w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5'>
            <div className='space-y-2'>
              <div className='flex items-center justify-between'>
                ...
                <button type="button" onClick={closesGuestsModal}>
            ...
            <div className='flex flex-wrap gap-2'>
              {emailsToInvite.map(email => {
                return (
                  //key é necessária ao utilizar o map e deve ser unica para cada elemento
            ...
            <form onSubmit={addNewEmailToInvite} action="" className='p-2.5 bg-zinc-950 border border-zinc-800 rounded-lg flex items-center gap-2'>
              ...
              <button type="submit" className='bg-lime-300 text-lime-950 rounded-lg 
              px-5 py-2 font-medium flex items-center gap-2 hover:bg-lime-400'>
              Convidar
